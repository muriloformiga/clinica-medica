 ...
 * @author Ivisson
 */
public class BuscarVisualizarConsultaView extends javax.swing.JFrame {

    /**
     * Creates new form CadastrarConsultaView
     */
    public BuscarVisualizarConsultaView() {
        initComponents();
    ...
    private void btnBuscarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarFuncionarioActionPerformed
       ...
       if(med.medico.getCpf()== null){
           txtErro.setText("Médico não encontrado!");
            ...
            consulta.medico.setId(med.medico.getId());
            
            consultas = consulta.consultasMarcadasMedico();
            
  
            VisualizarAgendaConsultaView frm = new VisualizarAgendaConsultaView();
            ...
            consultas2 = consulta.consultasRealizadasMedico();
